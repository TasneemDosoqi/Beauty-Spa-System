...
CREATE TABLE `ATTENDANT` (
  ...
  `V_Membership` int(11) NOT NULL,
  PRIMARY KEY (`Name`,`V_Membership`,`BD`),
  KEY `memID_idx` (`V_Membership`),
  CONSTRAINT `memID` FOREIGN KEY (`V_Membership`) REFERENCES `VOLUNTEER` (`Membership_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
